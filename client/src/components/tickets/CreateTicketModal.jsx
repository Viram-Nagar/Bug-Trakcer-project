...
function CreateTicketModal({
  ...
  const handleTagKeyDown = (e) => {
    if ((e.key === "Enter" || e.key === ",") && tagInput.trim()) {
      ...
      if (formData.tags.length >= 5) {
        return toast.error("Maximum 5 tags allowed");
      }
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title.trim()) {
      return toast.error("Ticket title is required");
    }
          ...
          >
            ...
            >
              ...
              >
                      ...
                      {formData.tags.map((tag) => (
                        <span
                          ...
                          className="flex items-center gap-1 bg-blue-50
                                     text-blue-600 text-xs px-2.5 py-1
                ...
                <div
                  className="flex gap-3 pt-2 sticky bottom-0 bg-white
                                pb-1"
                >
                  <button
                    type="button"
