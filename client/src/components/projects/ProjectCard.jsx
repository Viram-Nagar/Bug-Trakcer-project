      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* ── Always visible ⋮ menu for mobile ────── */}
            {isOwner && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
...
// import { useDispatch, useSelector } from "react-redux";
// import { useNavigate } from "react-router-dom";
// import { Trash2, Pencil, Users, Calendar, ArrowRight } from "lucide-react";
// import toast from "react-hot-toast";
// import {
//   deleteProject,
//   selectProjectLoading,
...
//         {/* Color bar */}
//         <div
//           className="h-1 rounded-full mb-5 opacity-60"
//           style={{ backgroundColor: project.color }}
//         />
...
//       whileHover={{ y: -4, transition: { duration: 0.2 } }}
//       onClick={() => navigate(`/projects/${project._id}`)}
//       className="bg-white rounded-2xl border border-gray-100 p-6 cursor-pointer
...
//       {/* Title */}
//       <h3
//         className="font-bold text-gray-900 text-lg mb-1 group-hover:text-blue-600
...
//       {/* Description */}
//       <p className="text-gray-500 text-sm mb-5 line-clamp-2 min-h-10">
//         {project.description || "No description provided"}
//       </p>
...
//               <div
//                 key={i}
//                 className="w-7 h-7 rounded-full bg-linear-to-br from-blue-400
//                            to-indigo-500 border-2 border-white flex items-center
...
//             {project.members?.length > 3 && (
//               <div
//                 className="w-7 h-7 rounded-full bg-gray-100 border-2
//                               border-white flex items-center justify-center
