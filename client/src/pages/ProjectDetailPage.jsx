        ...
        >
          ...
          >
            ...
            <div className="p-8 text-center text-gray-400">
              <p className="text-sm">
                Click "View All Tickets" to manage project tickets
              </p>
            </div>
          </motion.div>
        </motion.div> */}
...
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         className="bg-white rounded-2xl border border-gray-100 p-8 mb-6 shadow-sm"
//       >
//         <div className="flex items-start gap-5">
//           <div
//             className="w-16 h-16 rounded-2xl flex items-center justify-center
//                        text-3xl shadow-sm flex-shrink-0"
//             style={{ backgroundColor: project.color + "20" }}
//           >
//             {project.icon}
//           </div>
...
//               </div>
//               <span
//                 className="text-xs bg-gray-100 text-gray-600 px-2.5 py-1
...
//       {/* Tickets placeholder — Day 5 */}
//       <motion.div
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ delay: 0.2 }}
//         className="mt-6 bg-white rounded-2xl border border-gray-100 p-8
//                    shadow-sm text-center"
//       >
//         <div className="text-4xl mb-3">🎫</div>
//         <p className="text-gray-500 font-medium">Tickets coming on Day 5!</p>
//       </motion.div>
//     </div>
//   );
// }
